...
repository](https://github.com/IBM/run-campaigns-target-customers).

A good way to familiarize yourself with the codebase and contribution process is
to look for and tackle low-hanging fruit in the [issue
tracker](https://github.com/IBM/run-campaigns-target-customers/issues). Before embarking on 
...
issue](https://github.com/IBM/run-campaigns-target-customers/issues) before sending a pull
...
Please feel free to connect with us on our [here](https://github.com/IBM/run-campaigns-target-customers/issues).
